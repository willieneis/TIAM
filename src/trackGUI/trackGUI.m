...
% Loading in the data
tiamFile = './data/benchMarkResults/exp1_control_results.mat'; % _withEdits.mat
%tiamFile = './data/benchMarkResults/exp4_fc12_results.mat'; % _withEdits.mat
...
handles.frameSizeX = 225; % 225 680.15
handles.frameSizeY = 225; % 225 680.15

% Loads in pictures
for i = 1:handles.manyFrames
    handles.images{1,i} = imread(fullfile(...
        'data','exp1',ch1PicNames(i).name));
    handles.images{1,i} = imresize(...
        handles.images{1,i}, [handles.frameSizeX handles.frameSizeY]); %[225 225]
    handles.images{2,i} = imread(fullfile(...
        'data','exp1',ch2PicNames(i).name));
    handles.images{2,i} = imresize(...
        handles.images{2,i}, [handles.frameSizeX handles.frameSizeY]); %[225 225]
end
...
hold on;
%hold all;
axis([0 handles.frameSizeX 0 handles.frameSizeY]) 
% [0 handles.frameSizeX 0 handles.frameSizeY] [handles.frameSizeX/2 handles.frameSizeX handles.frameSizeY/2 handles.frameSizeY]
axis square;
